...
from .views import home_page_view, add_room, list_room, detail_room, modify_room, delete_room, reserve_room, search_room
...
urlpatterns = [
    ...
    path('room/search', search_room, name='search_room'),
